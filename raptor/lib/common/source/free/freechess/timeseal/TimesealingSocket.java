    ...
    implements Runnable
{
    private class a extends OutputStream
    {
            ...
            throws IOException
        {
            if(i == 10)
                ...
                {
                    int j = a(_fldif.toByteArray(), System.currentTimeMillis() - TimesealingSocket.this.initialTIme);
                    _flddo.write(a, 0, j);
                    _flddo.flush();
                    _fldif.reset();
                }
        ...
        private final byte initialTIme[] = "Timestamp (FICS) v1.0 - programmed by Henrik Gram.".getBytes();
        private byte a[];
    ...
    public TimesealingSocket(String s, int i)
        throws IOException
    {
        super(s, i);
        _flddo = new c(10000);
